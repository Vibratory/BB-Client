    ...
    <div className="flex flex-col text-center gap-8 py-8 px-5">
      <div className="md:flex md:justify-center px-2">
        ...
        {title == "% Solde %" ? (
          ...
          <p className="text-red-600 text-heading1-bold font-tsukimi-rounded bg-[#67bac0] rounded-br-[40px] pb-4 pt-2 md:w-fit md:px-5  rounded-bl-[40px] max-md:text-center max-sm:text-heading2-bold max-md:pb-3">
            {title}
          </p>
        ) : (
